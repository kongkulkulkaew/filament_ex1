...
namespace App\Filament\Resources\ExampleFormObject\Schemas;
    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Wizard::make([
                                ...
                                Grid::make(2)
                                    ->schema([
                                        ...
                                        TextInput::make('salary')
                                            ...
                                            ->helperText('กรอกเงินเดือน (บาท)')
                                            ->afterStateUpdated(function ($state, Set $set) {
                                                // แจ้งเตือนเมื่อเงินเดือน > 100000
                                                if ($state && $state > 100000) {
                                                    Notification::make()
                                                        ->title('เงินเดือนสูง')
                                                        ->body('เงินเดือนที่กรอกสูงกว่า 100,000 บาท กรุณาตรวจสอบความถูกต้อง')
                                                        ->warning()
                                                        ->send();
                                                }
                                            }),
                                        ...
                                        DatePicker::make('start_date')
                                            ...
                                            ->native(false)
                                            ->displayFormat('d/m/Y')
                                            ->helperText('เลือกวันที่เริ่มงาน')
                                            ->afterStateUpdated(function ($state, Set $set) {
                                                ...
                                                if ($state) {
                                                    ...
                                                    if ($selectedDate->lt($today)) {
                                                        ...
                                                        Notification::make()
                                                            ...
                                                            ->body('วันที่เริ่มงานต้องไม่น้อยกว่าวันนี้ กรุณาเลือกวันที่ใหม่')
                                                            ->warning()
                                                            ->send();
                                                    }
                                                }
                ...
                ->submitActionLabel('บันทึก')
                ->cancelActionLabel('ยกเลิก')
                ->columnSpanFull(),
        ]);
    }
}
